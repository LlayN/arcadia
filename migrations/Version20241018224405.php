 ...
 */
final class Version20241018224405 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE animals ADD consultation INT NOT NULL, ADD consultation_ip JSON DEFAULT NULL');
